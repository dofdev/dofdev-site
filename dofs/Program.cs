  ...
  class Program
  {
    ...
    static void Main(string[] args)
    {
      ...
      for (int i = 0; i < dofs.Length; i++)
      {
        ...
        html += "<a class='fineprint' href='/dofs' style='text-decoration: underline; text-align: right; display: block; margin-bottom: 0.5em;'>MIT License | Copyright © 2018-2021 dofdev</a>";
        html += $"{content}";
        html += $"";
